/// Drawing dialogue
if global.debug == false and roomStart {
    ...
    if (interacting and finished == false) {
        ...
        draw_text_transformed_color(textX, textY, objDialogue.dialogue[1, currentLine], 1.5, 1.5, 0, diaColor, diaColor, diaColor, diaColor, 1);
        draw_set_halign(fa_left);
        draw_set_valign(fa_top);
    }
}

if finished {objPlayer.allowMovement = true;}
