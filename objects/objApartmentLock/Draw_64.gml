...
if (place_meeting(x, y, objPlayer)) {
    if (keyboard_check_pressed(vk_space)) {
        if (interacting) {  // If already interacting, advance dialogue
			...
			if !global.seiraIntro {currentLine = 1; maxLine = 2;}
			interacting = true
        }
    }
}
if (interacting) {
	...
	draw_text_transformed_color(textX, textY, objDialogue.dialogue[9, currentLine], 1.5, 1.5, 0, diaColor, diaColor, diaColor, diaColor, 1);
